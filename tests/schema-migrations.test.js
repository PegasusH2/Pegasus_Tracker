...
describe('Actualización desde v1 (usuario con la app instalada desde el principio)', () => {
  test('sube de v1 a la última versión sin lanzar y preservando los datos ya guardados', async () => {
    ...
    // v19: muscleGroup se retira por completo, incluso de datos ya guardados
    // de un usuario antiguo (no solo se deja de leer/escribir de aquí en adelante).
    assert.equal(exercise.muscleGroup, undefined);
